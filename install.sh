...
su - creativeteam -c '
# Prompt user to run extensions.sh, with a 10-second timeout and default to "Y"
read -t 10 -p "Do you want to run extensions.sh now? (Y/N): " run_extensions

# If no input is provided, default to "Y"
run_extensions=${run_extensions:-Y}
